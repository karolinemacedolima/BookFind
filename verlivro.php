...
<head>
  ...
  <?php
					$id=$_GET["id"];
							$select="select *from livros where idlivros='$id'";
...
<div id="tituloend"> 
 ...
 <div id="botao">
<a href="chatpessoa.php?id=<?php echo $dados->id_de;?>&idusuario=<?php echo $idusu;?>&tipo_de=<?php echo $tipo_de;?>&tipo_para=<?php echo $dados->tipo?>" class="btn btn-default btn-lg">Conversar com o dono</a>
