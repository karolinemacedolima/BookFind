...
<head>
  ...
  <?php
					$id=$_GET["id"];
							$select="select *from pendencias where idpendencias='$id'";
...
<div id="tituloend"> 
 ...
 <div id="botao">
<?php
      echo "<a href='aprovar.php?id=" . $dados->idpendencias . "' class='btn btn-default btn-lg'>Aprovar</a><br>";
echo "<a href='recusar.php?id=" . $dados->idpendencias . "' class='btn btn-default btn-lg'>Recusar</a><br>";
     ?>
</div>
