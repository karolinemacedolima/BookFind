...
<div id="mapa">
<div id= "txtimg"> 
<h1><p class="text-center">Instituições</p></h1>
</div>
   <div id="myBtn2">
...
<form method="POST" action="buscainsti.php">
<input type="text"  name="busca" required id="busca" placeholder="Busque a instituição pelo nome"  style="width: 75%; ">
...
$result_usuario = "SELECT * FROM insti ";
